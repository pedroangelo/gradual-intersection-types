...
-- (\x : Int -> Int /\ Dyn . x 1 + x true) (\y : Int . y + 1)
...
-- (\x : (((Int /\ Dyn) -> Int) /\ Dyn) -> Int . x (\y : Int . y + 1)) (\z : Int -> Int . z 1)
...
-- (\x : (((Int /\ Dyn) -> Int) /\ Dyn) -> Int . x (\y : Dyn . y + 1)) (\z : Dyn . z true)
...
-- (\x : ((Int -> Int) -> Int -> Int) /\ (Int -> Int) . x x) (\y : Int -> Int /\ Int . y)
...
-- (\x : ((Int -> Int) -> Int -> Int) /\ (Int -> Int) . x x) (\y : Int -> Int /\ Int . y) 1
...
-- (\x : Dyn . x x) (\y : Int -> Int /\ Int . y) True
...
-- (\x : ((Int -> Int) -> Int -> Int) /\ (Int -> Int). x x) (\y : Dyn . y) 1
...
-- (\\x : Dyn /\ Int -> Int . x x) (\\y : Int -> Int /\ Int . y) 1
...
-- (\\x : (Int -> Int) -> Int -> Int /\ Dyn . x x) (\\y : Int -> Int /\ Int . y) 1
...
-- (\x : ((Int -> Int) -> Int -> Int) /\ (Int -> Int) . x x) (\y : Dyn /\ Int . y) 1
...
-- (\x : ((Int -> Int) -> Int -> Int) /\ (Int -> Int) . x x) (\y : Int -> Int /\ Dyn . y) 1
...
-- (\x : Dyn /\ (Int -> Int) . x x) (\y : Dyn /\ Int . y) 1
