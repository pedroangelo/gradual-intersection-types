...
%    As $\Gamma \iccts v : I_1 \cap \ldots \cap I_m$ and therefore $\Gamma \iccts v : c_1' \cap \ldots \cap c_m' : T_2 \cap \ldots \cap T_2$ and $T_2 \cap \ldots \cap T_2 = T_2$ and by rule E-MergeIC, $v : cv_1 \cap \ldots \cap cv_n : T_1 \Rightarrow^l T_2 \gios v : c_1' \cap \ldots \cap c_m'$, then it is proved.
%    \item Rule E-MergeCI.
...
%    As $\Gamma \iccts v : c_1' \cap \ldots \cap c_n' : F_1 \cap \ldots \cap F_n$ and by rule E-MergeCI, $v : T_1 \Rightarrow^l T_2 : c_1 \cap \ldots \cap c_n \gios v : c_1' \cap \ldots \cap c_n'$, then it is proved.
