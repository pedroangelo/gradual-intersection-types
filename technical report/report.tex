...
\inferrule* [right=Merge1$\cap$]
{isValue\ v : cv_1 \cap \ldots \cap cv_n \\ label(c_1) = m_1\ \ldots\ label (c_n) = m_n}
...
\inferrule* [right=Merge2$\cap$]
{isIntersectionCast\ v \lor isCast\ v \\ v' : c_1' \cap \ldots \cap c_m' = mergeCasts (v : c_1 \cap \ldots \cap c_n)}
{v : c_1 \cap \ldots \cap c_n \longrightarrow_{\cap CC} v' : c_1' \cap \ldots \cap c_m'}\\
